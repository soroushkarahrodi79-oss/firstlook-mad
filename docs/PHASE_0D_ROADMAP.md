...
characterises the **synthetic** mechanism (survived T1/T2/T4-SYNTH; diagnostic
`FAILS` on T3-SYNTH and T6, both known from 0C.1) and **never** drives the formal
gate. Report: `PHASE_0D4_ADVERSARIAL_FALSIFICATION_GATE_REPORT.md`;
